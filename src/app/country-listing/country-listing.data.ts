import { CountryCard, UserData } from './country-listing.interface';
...
const TIMELINE_DATA: UserData[] = [
  {
    ...
    photoURL:
      'https://hips.hearstapps.com/hmg-prod/images/screen-shot-2020-07-16-at-16-32-03-1594914078.png',
    flag: 'fr',
    device: 'Windows',
  ...
  },
  {
    ...
    photoURL:
      'https://e00-elmundo.uecdn.es/assets/multimedia/imagenes/2022/11/29/16697627516809.jpg',
    flag: 'pe',
    device: 'Macbook PRO',
...
const COUNTRY_DATA: CountryCard[] = [
  {
    id: '230918',
    country: 'Perú',
    visa: false,
    language: 'Español',
    typeOfMoney: 'Nuevo Sol',
    flag: 'pe',
...
export { TIMELINE_DATA, COUNTRY_DATA };
